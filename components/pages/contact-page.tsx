...
export function ContactPage({ onNavigate }: ContactPageProps) {
  ...
  const stats = [
    ...
    { icon: Clock, value: "3", label: "Major Projects" },
    { icon: CheckCircle, value: "400+", label: "DSA Problems Solved" },
  ]

  return (
    <section className="min-h-screen py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Interested in collaborating on a project, discussing opportunities, or just want to connect? As a passionate
            CS student eager to learn and contribute, I'd love to hear from you!
          </p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-8 text-lg">
                ...
                about technology and learning. As a B.Tech Computer Science student with hands-on experience in
                full-stack development and machine learning, I'm eager to apply my skills in real-world scenarios.
              </p>
            </div>
