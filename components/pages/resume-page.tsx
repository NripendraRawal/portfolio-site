...
export function ResumePage({ onNavigate }: ResumePageProps) {
  ...
  return (
    <section className="min-h-screen py-20 bg-gradient-to-br from-white via-gray-50 to-blue-50/30 relative">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <Button
              size="lg"
              variant="ghost"
              className="text-gray-600 hover:text-gray-900 px-8 py-3 rounded-2xl hover:bg-white/50 backdrop-blur-sm transition-all duration-300"
            >
